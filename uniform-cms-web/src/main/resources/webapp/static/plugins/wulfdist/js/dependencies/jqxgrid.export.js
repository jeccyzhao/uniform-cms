...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        exportdata: function(s, B, A, q, t, v, excludedColumns, h) {
            // s: dataType
            // B: fileName
            // A: exportHeader
            // q: rows
            // t: exportHiddenColumns
            // v: serverURL
            // h: charSet
            ...
            if (q == undefined) {
                ...
                if (excludedColumns != undefined) {
                    for (var colIndex in excludedColumns) {
                        for (var i = 0; i < q.length; i++) {
                            delete q[i][excludedColumns[colIndex]];
                        }
                    }
                }
                if (q.length == 0) {
            ...
            function(N) {
                ...
                if (excludedColumns != undefined && excludedColumns.inArray(this.datafield)) { return; }
                ...
                if (s == "html" || s == "xls" || s == "pdf") {
                    var i = function(S, aa, Z, T, Y, V, U, W, X) {
                        //if (excludedColumns != undefined && excludedColumns.inArray(Y.datafield)) {
                        //    return;
                        //}
                        p[S] = {};
                        if (aa == undefined) {
            ...
            function(i) {
                if (G[this.displayfield]) {
                    if (excludedColumns != undefined && excludedColumns.inArray(this.displayfield)) {
                        delete G[this.displayfield];
                    } else {
