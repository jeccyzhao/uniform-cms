...
var pdfDataExport = (function() {
    ...
    var c = typeof Object.keys === "function" ?
    function(d) {
    ...
    function b(E, ae, M, V) {
        ...
        for (aq in b.API) {
            if (b.API.hasOwnProperty(aq)) {
                if (aq === "events" && b.API.events.length) { (function(ax, az) {
                        var ay, aw, k;
    ...
    i.getKeys = (typeof Object.keys === "function") ?
    function(p) {
        if (!p) {
            return []
        }
...
var saveAs = saveAs || (navigator.msSaveBlob && navigator.msSaveBlob.bind(navigator)) || (function(h) {
    ...
    m = function(s) { (h.setImmediate || h.setTimeout)(function() {
            throw s
        },
        0)
    },
